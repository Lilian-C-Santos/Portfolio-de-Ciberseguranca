...
Em redes corporativas em expansão, a configuração manual de endereços IP (estática) em cada estação de trabalho é ineficiente, sujeira a erros humanos (como duplicidade de IPs) e gera um alto custo operacional para a equipe de TI. Além disso, a falta de controle centralizado dificulta a aplicação de políticas de rede e navegação.
...
## 2. Matriz de Endereçamento e Escopo DHCP
